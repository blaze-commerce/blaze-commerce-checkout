				...
				<td class="blaze-coupon-container" colspan="2">
					<div class="coupon-code-container">
						...
						<div class="coupon-code-form blaze-form-toggle">
							<input type="text" id="coupon-code-input" placeholder="Enter promo code"/>
                ...
                foreach ( $packages as $i => $package ) {
                    ...
                    foreach ($package['rates'] as $method) {
                        if ( $method->id == $chosen_method ) {
                            $shipping_method = wc_cart_totals_shipping_method_label( $method );
                        }
                    }
                }
            ?>
            <tr class="cart-subtotal blaze-shipping-review">
				<th>Shipping</th>
